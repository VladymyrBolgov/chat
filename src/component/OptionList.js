...
const Item = styled.div`
  ...
  display: flex;
  /* робимо спільну висоту елементів "Заголовок" та "Іконка" */
  align-items: stretch;

  /* Відступ справа та зліва, щоб елемент "Заголовок" та "Іконка" не налазили на краї */
  padding-left: 16px;
  padding-right: 16px;
